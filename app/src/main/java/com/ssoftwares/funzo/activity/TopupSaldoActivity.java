...
public class TopupSaldoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setText(sp.getSetting()[0]+"10");
        button2.setText(sp.getSetting()[0]+"20");
        button3.setText(sp.getSetting()[0]+"50");
        button4.setText(sp.getSetting()[0]+"100");



        // aise kr sakte theee baki button ke liye bhi kar
